metaprompt_texts = {
    "claude" :{
        "template": '''Today you will be writing instructions to an eager, helpful, but inexperienced and unworldly AI assistant who needs careful instruction and examples to understand how best to behave. I will explain a task to you. You will write instructions that will direct the assistant on how best to accomplish the task consistently, accurately, and correctly. These instructions must be written using natural language (don't include tags at the response), this must be a complete instructions set with the full information on how to accomplish the task. Here are some examples of tasks and instructions.
